...
export default function ArchivesEPosters2025Page() {
    ...
    const fetchEPosters = async () => {
        try {
            const response = await axiosInstance.get('/eposters/public?annee=2025');
                    ...
                    <div className="container mx-auto px-4">
                        {loading ? (
                            ...
                            <div className="text-center py-20">
                                ...
                                <p className="text-gray-500 text-lg">Aucun e-poster disponible pour 2025</p>
                            </div>
                        ) : (
